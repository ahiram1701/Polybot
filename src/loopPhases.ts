...
export const LOOP_PHASES = ["fetch", "reconcile", "resolve", "capture", "decide", "verify", "maker", "perps"] as const;
...
export function emptyPhases(): LoopPhaseMs {
  return { fetch: 0, reconcile: 0, resolve: 0, capture: 0, decide: 0, verify: 0, maker: 0, perps: 0 };
}
