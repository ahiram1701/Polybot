...
export class BotController {
  ...
  private sanitizeConfig(config: BotConfig, settings: UiSettings): SanitizedConfig {
    return {
      ...
      favoriteExitCertainty: config.favoriteExitCertainty ?? settings.favoriteExitCertainty,
      ...
      favoriteExitMaxSpread: config.favoriteExitMaxSpread ?? settings.favoriteExitMaxSpread,
      favoriteExitMinHoldSeconds: config.favoriteExitMinHoldSeconds ?? settings.favoriteExitMinHoldSeconds,
      favoriteExitAllowLive: config.favoriteExitAllowLive ?? settings.favoriteExitAllowLive,
      ...
      makerTicksDelMedio: config.makerTicksDelMedio ?? settings.makerTicksDelMedio,
