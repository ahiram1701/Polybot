...
const settingsSchema = z.object({
  ...
  favoriteMaxSizeFraction: z.coerce.number().gt(0).lte(1).default(0.5),
  favoriteExitEnabled: z.boolean().default(false),
  favoriteExitStopMargin: z.coerce.number().gte(0).lt(1).default(0.01),
  favoriteExitStopAsk: z.coerce.number().gt(0).lt(1).default(0.69),
  favoriteMinCertainty: z.coerce.number().default(1),
  favoriteExitCertainty: z.coerce.number().default(0),
  favoriteExitMinSecondsToEnd: z.coerce.number().nonnegative().default(45),
  favoriteExitMinBid: z.coerce.number().gt(0).lt(1).default(0.05),
  favoriteExitMinFillRatio: z.coerce.number().min(0).max(1).default(0.9),
  favoriteExitMaxSpread: z.coerce.number().gt(0).lt(1).default(0.1),
  favoriteExitMinHoldSeconds: z.coerce.number().nonnegative().default(10),
  favoriteExitAllowLive: z.boolean().default(false),
...
export function settingsFromConfig(config: BotConfig): UiSettings {
  ...
  return {
    ...
    favoriteMaxSizeFraction: config.favoriteMaxSizeFraction ?? 0.5,
    favoriteExitEnabled: Boolean(config.favoriteExitEnabled ?? false),
    favoriteExitStopMargin: config.favoriteExitStopMargin ?? 0.01,
    favoriteExitStopAsk: config.favoriteExitStopAsk ?? 0.69,
    favoriteMinCertainty: config.favoriteMinCertainty ?? 1,
    favoriteExitCertainty: config.favoriteExitCertainty ?? 0,
    favoriteExitMinSecondsToEnd: config.favoriteExitMinSecondsToEnd ?? 45,
    favoriteExitMinBid: config.favoriteExitMinBid ?? 0.05,
    favoriteExitMinFillRatio: config.favoriteExitMinFillRatio ?? 0.9,
    favoriteExitMaxSpread: config.favoriteExitMaxSpread ?? 0.1,
    favoriteExitMinHoldSeconds: config.favoriteExitMinHoldSeconds ?? 10,
    favoriteExitAllowLive: Boolean(config.favoriteExitAllowLive ?? false),
...
export function applySettings(config: BotConfig, settings: UiSettings): BotConfig {
  ...
  return {
    ...
    favoriteMaxSizeFraction: settings.favoriteMaxSizeFraction,
    favoriteExitEnabled: settings.favoriteExitEnabled,
    favoriteExitStopMargin: settings.favoriteExitStopMargin,
    favoriteExitStopAsk: settings.favoriteExitStopAsk,
    favoriteMinCertainty: settings.favoriteMinCertainty,
    favoriteExitCertainty: settings.favoriteExitCertainty,
    favoriteExitMinSecondsToEnd: settings.favoriteExitMinSecondsToEnd,
    favoriteExitMinBid: settings.favoriteExitMinBid,
    favoriteExitMinFillRatio: settings.favoriteExitMinFillRatio,
    favoriteExitMaxSpread: settings.favoriteExitMaxSpread,
    favoriteExitMinHoldSeconds: settings.favoriteExitMinHoldSeconds,
    favoriteExitAllowLive: settings.favoriteExitAllowLive,
